...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SEL_AXI_IN_v1_0 is
  ...
  signal \reg_sel_reg[1]_i_1_n_0\ : STD_LOGIC;
...
\reg_sel_reg[1]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => axi_in_aresetn,
      O => \reg_sel_reg[1]_i_1_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
