...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axis_out is
  ...
  attribute SOFT_HLUTNM of \read_pointer[8]_i_3\ : label is "soft_lutpair24";
begin
  Q(8 downto 0) <= \^q\(8 downto 0);
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_control is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of Mem_h_reg_i_11 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of Mem_h_reg_i_12 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of Mem_h_reg_i_14 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of Mem_h_reg_i_15 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \k[1]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \k[7]_i_2\ : label is "soft_lutpair9";
...
Mem_h_reg_i_13: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
Mem_h_reg_i_14: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
Mem_h_reg_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F4FF0A00"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mem_h is
  port (
    ...
    Mem_r_reg : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mem_h is
  ...
  attribute SOFT_HLUTNM of \i__carry__2_i_6\ : label is "soft_lutpair17";
...
\MEM_H[0].mem_h\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mem_h
     port map (
      ...
      Mem_r_reg(3 downto 0) => Mem_r_reg(3 downto 0),
      Q(8 downto 0) => Q(8 downto 0),
      S(0) => S(0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ms2xs is
  ...
  signal Control_M_n_29 : STD_LOGIC;
...
Mems: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mems
     port map (
      ...
      Mem_r_reg(3) => Mems_n_28,
      Mem_r_reg(2) => Mems_n_29,
      Mem_r_reg(1) => Mems_n_30,
      Mem_r_reg(0) => Mems_n_31,
