...
simulate()
{
  xsim BD -key {Behavioral:sim_1:Functional:BD} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5c0d.protoinst" -protoinst "protoinst_files/BD.protoinst" -log simulate.log
}
